...
<head>
    ...
    <title>Delete Teacher's Upload</title>
...
if(isset($_POST['submit']))
{
    ...
    $imagename = $_FILES['file'] ['name'];
            ...
            move_uploaded_file($tempimgname,"upload_t/$imagename");
            $sql = "INSERT INTO `upload_t`(`title`, `file`, `name`, `date`, `time`, `fid`, `ufor`, `tid`) VALUES ('$title','$imagename','$name','$date','$time','$fid','$ufor','$tid')";
